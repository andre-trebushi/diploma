...
dfl_SERVAL_intensity_conv = undulator_field_dfl_SERVAL(dfl1, L_w=L_w, 
                                        sig_x=ebeam_sigma_x, sig_y=ebeam_sigma_y, 
                                        sig_xp=ebeam_sigma_xp, sig_yp=ebeam_sigma_yp,
                                        k_support = 'intensity', s_support='conv', showfig=False)

dfl_SERVAL_amplitude_beam = undulator_field_dfl_SERVAL(dfl2, L_w=L_w, 
                                        sig_x=ebeam_sigma_x, sig_y=ebeam_sigma_y, 
                                        sig_xp=ebeam_sigma_xp, sig_yp=ebeam_sigma_yp,
                                        k_support = 'amplitude', s_support='beam', showfig=False)

dfl_SP = undulator_field_dfl_MP(dfl3, z=25, L_w=L_w, E_ph=E_ph, N_e=N_e, N_b=N_b,
...
dfl_SP.prop_m(-25, m=0.4)
# plot_dfl(dfl_SERVAL_intensity_conv)
# plot_dfl(dfl_SERVAL_amplitude_beam)
plot_dfl(dfl_SP)

plot_dfls([dfl_SERVAL_intensity_conv])#, dfl_SERVAL_amplitude_beam, dfl_SP])
